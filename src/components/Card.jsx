  ...
  <div className="card2">
    <div className="upper">
      <div className="humidity">
        <div className="humiditytext">Humidity<br/>{weatherState.fetchedData?.current?.humidity}%</div>
      ...
      <div className="air">
        <div className="airtext">Wind<br/>{weatherState.fetchedData?.current?.wind_kph} Km/h</div>
    ...
    <div className="lower">
      <div className="aqi">
        ...
        <div className="aqitext">AQI<br/>{weatherState.fetchedData?.current?.air_quality?.co}</div>
      </div>
      ...
      <div className="realfeel">
        ...
        <div className="realfeeltext">Real Feel<br/>{weatherState.fetchedData?.current?.feelslike_c} °C</div>
      </div>
      ...
      <div className="pressure">
        ...
        <div className="pressuretext">Pressure<br/>{weatherState.fetchedData?.current?.pressure_mb}</div>
      </div>
      <div className="card3">
      Healthy
      </div>
